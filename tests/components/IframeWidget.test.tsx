...
describe('IframeWidget', () => {
  ...
  it('有効なURLをサンドボックス付き iframe で埋め込むこと', () => {
  ...
  it('スキームの無いURLは iframe にせず不正URLメッセージを出すこと（クラッシュしない）', () => {
  ...
  it('javascript: / data: URL を拒否すること', () => {
...
describe('utils/url', () => {
  ...
  it('normalizeHttpUrl がスキームを補い、安全でないものは null にすること', () => {
