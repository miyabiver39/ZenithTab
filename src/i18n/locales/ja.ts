export const ja = {
  ...
  widgets: {
    ...
    search: {
      ...
      engineListHint: '★ をクリックすると既定のエンジンになります。',
      setDefault: '既定にする',
      defaultBadge: '既定',
      fromCatalog: 'カタログから追加',
      manualAdd: 'URL を指定して追加',
    ...
    calendar: {
      title: 'カレンダー',
      desc: 'iCal(.ics)リンクから今日と直近の予定を表示。Google カレンダー・Outlook・Apple に対応。',
      today: '今日',
      tomorrow: '明日',
      allDay: '終日',
      untitled: '(無題)',
      empty: '予定はありません。',
      noFeeds: 'カレンダーのリンクを追加すると、ここに予定が表示されます。',
      addFeed: 'カレンダーを追加',
      addFeedHelp: 'iCal / .ics のリンクを貼り付けてください。Google カレンダーでは 設定 → 対象のカレンダー → 「iCal 形式の非公開 URL」です。',
      addBtn: '追加',
      feeds: 'カレンダー',
      noFeedsConfig: 'まだカレンダーがありません。',
      labelField: '名前',
      labelPlaceholder: '例: 仕事',
      urlField: 'iCal の URL',
      colorField: '色',
      defaultLabel: 'カレンダー',
      invalidUrl: 'https:// または webcal:// のリンクを入力してください。',
      daysAhead: '表示期間',
      daysAheadOption: '{n} 日',
      showLocation: '場所を表示',
      permissionNeeded: 'このカレンダーを読み込むには許可が必要です。',
  ...
  share: {
    title: 'この構成を共有',
    desc: '今のページ(と、必要ならドック)を短いコードにします。チャットに貼ったり QR コードで見せたりできます。メモ・タスク・習慣の履歴・カレンダーのリンク・カウントダウン・天気の位置は含まれません。',
    includeDock: 'ドックも含める',
    create: '共有コードを作成',
    importTitle: '共有コードを受け取ったら、ここに貼り付け',
    invalid: 'ZenithTab の共有コードではありません。',
    preview: '「{name}」 · ウィジェット {widgets} 個',
    previewDock: 'ドック {n} 件',
    replaceDock: '自分のドックも共有されたものに置き換える',
    addAsPage: '新しいページとして追加',
    imported: '共有されたページを追加しました(ウィジェット {n} 個)。',
    codeTitle: '共有コード',
    codeDesc: 'ZenithTab を使っている人なら、設定 › バックアップに貼り付けるだけで、このページを自分の新しいページとして受け取れます。',
    codeSize: '{n} 文字',
    copy: 'コードをコピー',
    copied: 'コピーしました',
    qrHint: '別の端末で読み取り、テキストを ZenithTab に貼り付けてください。',
    qrTooLong: 'コードが長すぎて QR にできません。テキストをコピーしてください。',
  },
  sync: {
    title: '設定を Chrome アカウントで同期',
    desc: '外観(言語を含む)・ドック・ショートカットキーを、同じアカウントでログインした Chrome 間で揃えます。ウィジェットやページはこの端末に留まります。',
    enable: '設定を同期する',
    unavailable: 'この環境では Chrome の同期ストレージを使えません。',
    skipped: '大きすぎて同期できない項目: {items}。Chrome は 1 項目あたり約 8 KB までです。',
  },
  today: {
    events: '今日の予定 {n} 件',
    tasks: '未完了タスク {n} 件',
    countdown: '{name}まで {n} 日',
    countdownToday: '今日は{name}',
  },
  setup: {
    title: 'ZenithTab へようこそ',
    subtitle: '3 つの質問で新しいタブが完成します。どれもスキップでき、あとから全部変えられます。',
    progress: 'ステップ {n} / {total}',
    stepRegion: '言語と地域',
    stepRegionDesc: '表示言語と、地域に合わせたよく使うサイト・ニュース・天気を決めます。',
    stepInterests: '興味のあるジャンルは?',
    stepInterestsDesc: 'ニュースのトピックと、いくつかのショートカットを追加します。空のままならトップニュースになります。',
    stepPurpose: 'このタブを何に使いますか?',
    stepPurposeDesc: 'ウィジェットの構成を決めます。テンプレートからページはいつでも追加できます。',
    skip: 'スキップ',
    back: '戻る',
    next: '次へ',
    finish: '完了',
    again: 'セットアップをもう一度',
    againDesc: '3 ステップのセットアップでダッシュボードを作り直します。実行前に今の状態をバックアップします(設定 › バックアップ)。',
    againBtn: 'もう一度セットアップ',
    hintSettings: 'ウィジェットにマウスを乗せて ⚙ を押すと設定できます',
    hintLayout: '右上の「レイアウト編集」で移動・サイズ変更',
    hintDismiss: 'このヒントを閉じる',
  },
  catalog: {
    siteTitle: 'サイトを追加',
    feedTitle: 'フィードを選ぶ',
  ...
  backup: {
    ...
    retention: '自動 {auto} 件・手動 {manual} 件・リセット前 / インポート前 / 復元前は各 {other} 件まで保持します(合計 {size} まで)。古いものから自動的に消えます。',
    reason: {
      auto: '自動',
      manual: '手動',
      beforeReset: 'リセット前',
