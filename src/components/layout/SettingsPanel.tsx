...
import { Image, Palette, Download, Upload, RotateCcw, Languages, Dock as DockIcon, Plus, ArrowUp, ArrowDown, Trash2, Keyboard, GripVertical, LayoutGrid, Layers, Undo2, History, Save } from 'lucide-react';
...
export const SettingsPanel: React.FC = () => {
  ...
  // Snapshots are only read when someone actually looks at them.
  useEffect(() => {
    if (isOpen && activeTab === 'backup') void refreshSnapshots();
  }, [isOpen, activeTab, refreshSnapshots]);
